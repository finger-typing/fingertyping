...
const GameControls: React.FC<GameControlsProps> = ({
  ...
  const buttonStyles = `
    ...
    ${
      darkMode
        ? "text-gray-200 hover:bg-gray-700 focus:ring-purple-500/50 border-gray-600"
        : "text-gray-800 hover:bg-gray-50 focus:ring-purple-600/50 border-gray-300"
    }
  `;
  ...
  const blankPageButtonStyles = `
    ...
    ${
      darkMode
        ? "text-white hover:bg-gray-700 focus:ring-blue-500/50 border-gray-600"
        : "text-gray-800 hover:bg-gray-50 focus:ring-blue-600/50 border-gray-300"
    }
  `;
  ...
  return (
    <div
      className={`mb-1 md:mb-2 flex w-full flex-col items-center justify-between mt-2 py-1 ${darkMode ? "bg-gray-900/30" : "bg-gradient-to-br from-white to-gray-50"} border ${darkMode ? "shadow-xl" : "shadow-none"} ${darkMode ? "border-gray-700" : "border-gray-300"} backdrop-blur-sm`}
      role="group"
    ...
    >
      ...
      <div className="flex w-full flex-row items-stretch justify-between gap-0 sm:flex-row">
        <Button
          ...
          className={`${isBlankPage ? blankPageButtonStyles : buttonStyles} flex-1 rounded-none `}
        ...
        <Button
          ...
          className={`${buttonStyles} flex-1 rounded-none `}
